...
public class AnalisadorSemantico {
    ...
    public void ValorConst() {
        ...
        if ((listaTokens.get(numTokenAtual).getClasse().equals("NUMERO")) || (listaTokens.get(numTokenAtual).getClasse().equals("CADEIA_CARACTERES")) || (token.equals("verdadeiro")) || (token.equals("falso"))) {
            ...
            } else if ((escopo2.equals("leia")) || ((escopo2.equals("escreva")))) {
                identificador = token;

                if ((identificador.equals("verdadeiro")) || ((identificador.equals("falso")))) {
                    listaErrosSemanticos.add(mensagemErroSemantico(linhaErro, "nao_suportado", ""));
                }
            }
            proximoToken();
        }  else {
